...
// Carga .env desde la raíz del monorepo (dos niveles arriba de apps/nexolaundry-api)
loadEnv({ path: join(process.cwd(), '../../.env') });
// Fallback: carga también desde el directorio actual por si se corre desde la raíz
